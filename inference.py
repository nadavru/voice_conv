...
v1 = data[k1][:segment_size]
v2 = data[k2][:segment_size]
...
v1 = torch.Tensor(v1)[None, ...].transpose(1, 2)
v2 = torch.Tensor(v2)[None, ...].transpose(1, 2)
